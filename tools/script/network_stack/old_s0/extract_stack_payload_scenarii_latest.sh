...
echo "extract_os_icmp_payload_scenarii_latest: protocol: ${protocol}"
...
function extract_payload() {
    ...
    latest_pcap_path="$os_directory_path/${protocol}_${scenario_name}_latest"
    json_path="$os_directory_path/${protocol}_${scenario_name}_payload.json"
