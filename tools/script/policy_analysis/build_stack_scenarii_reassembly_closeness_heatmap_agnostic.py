...
def build_custom_corr_matrix_hm(csv_data_v: list, scenario_v: list,
    ...
    for scenario_1 in scenario_v:
        ...
        for scenario_2 in scenario_v:
            print("build_custom_corr_matrix_hm: scenario_1,scenario_2: ",
            ...
            for hm_entry in csv_data_v:
                ...
                print("build_custom_corr_matrix_hm: curr_target_name_v: ",
                      curr_target_name_v)
            curr_target_name_v_no_duplicates = list(set(curr_target_name_v))
            print(
                "build_custom_corr_matrix_hm: curr_target_name_v_no_duplicates: ",
                curr_target_name_v_no_duplicates)
            curr_corr_score = len(curr_target_name_v_no_duplicates)
            print("build_custom_corr_matrix_hm: curr_corr_score: ",
                  curr_corr_score)
            scenario_1_corr_matrix_v.append(curr_corr_score)
            print("build_custom_corr_matrix_hm: scenario_1_corr_matrix_v: ",
                  scenario_1_corr_matrix_v)
...
def process(input_csv_filepath: str, output_plot_filepath: str):
    ...
    scenario_v_new_names = format_scenario_group_for_camera_ready(scenario_v)
    ax.set_xticks(range(corr_matrix.shape[1]), labels=scenario_v_new_names)
    ax.set_yticks(range(corr_matrix.shape[0]), labels=scenario_v_new_names)
