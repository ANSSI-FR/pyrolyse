...
echo "detect_scenarii_run: detect_script_path: ${detect_script_path}"
echo "detect_scenarii_run: midpoint_install_directory_path: ${midpoint_install_directory_path}"
echo "detect_scenarii_run: midpoint_configuration_directory_path: ${midpoint_configuration_directory_path}"
...
do
    ...
    "${PYROLYSE_PATH}/tools/script/midpoint/detect_scenarii.sh" \
    "${detect_script_path}" \
