...
function extract_simple_policies() {
  ...
  json_output_directory="${target_directory_path}/${protocol}/output_ids_json/${reassembly_options}"
  ...
  --payload-json-path "$target_directory_path/${protocol}/output/${reassembly_options}/${protocol}_pe${scenario}_payload.json" \
