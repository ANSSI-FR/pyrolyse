...
use crate::ip_full_policy::pair_ignore_interpretation::PairIgnoreInterpretation;
...
pub struct TripletReassemblyAlgorithmConsistency {
    qoaimnipa: PolicyConsistency,
    qoaimnipn: PolicyConsistency,
    qoaimnita: PolicyConsistency,
    qoadmnita: PolicyConsistency,
    qoaimmipa: PolicyConsistency,
    qoaimmipn: PolicyConsistency,
    qoaimmita: PolicyConsistency,
    qoadmmita: PolicyConsistency,
    qoaimaipa: PolicyConsistency,
    qoaimaipn: PolicyConsistency,
    qoaimaita: PolicyConsistency,
    qoadmaita: PolicyConsistency,
}
...
impl TripletReassemblyAlgorithmConsistency {
    ...
    pub fn of_data(
        ...
        let qoaimnipa = Self::build_queued_by_offset_fast_chunk_alteration_no_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
            payload_string_option,
            //triplet_position_policy,
            relation_triplet_d,
            PairIgnoreInterpretation::PairAllChunksDrop
        );
        let qoaimnipn = Self::build_queued_by_offset_fast_chunk_alteration_no_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
            ...
            //triplet_position_policy,
            relation_triplet_d,
            PairIgnoreInterpretation::PairNewestChunkDrop
        );

        let qoaimnita = Self::build_queued_by_offset_fast_chunk_alteration_no_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
            ...
            //triplet_position_policy,
            relation_triplet_d,
            PairIgnoreInterpretation::FlowAllChunksDrop
        );

        //let queued_by_offset_slow_chunk_alteration_no_merging_ignore_pair_all_drop = Self::build_queued_by_offset_slow_chunk_alteration_no_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairAllChunksDrop
        //);
        //let queued_by_offset_slow_chunk_alteration_no_merging_ignore_pair_newest_drop = Self::build_queued_by_offset_slow_chunk_alteration_no_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairNewestChunkDrop
        //);
        let qoadmnita = Self::build_queued_by_offset_slow_chunk_alteration_no_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimmipa = Self::build_queued_by_offset_meet_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimmipn = Self::build_queued_by_offset_meet_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimmita = Self::build_queued_by_offset_meet_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        //let queued_by_offset_slow_chunk_alteration_meet_merging_ignore_pair_all_drop = Self::build_queued_by_offset_meet_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairAllChunksDrop
        //);
        //let queued_by_offset_slow_chunk_alteration_meet_merging_ignore_pair_newest_drop = Self::build_queued_by_offset_meet_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairNewestChunkDrop
        //);
        let qoadmmita = Self::build_queued_by_offset_meet_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimaipa = Self::build_queued_by_offset_any_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimaipn = Self::build_queued_by_offset_any_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        let qoaimaita = Self::build_queued_by_offset_any_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        //let queued_by_offset_slow_chunk_alteration_any_merging_ignore_pair_all_drop = Self::build_queued_by_offset_any_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairAllChunksDrop
        //);
        //let queued_by_offset_slow_chunk_alteration_any_merging_ignore_pair_newest_drop = Self::build_queued_by_offset_any_merging(
        //    payload_mode,
        //    interval_c,
        //    chunk_c,
        //    pair_relation_time_choice,
        ...
        //    PairIgnoreInterpretation::PairNewestChunkDrop
        //);
        let qoadmaita = Self::build_queued_by_offset_any_merging(
            payload_mode,
            interval_c,
            chunk_c,
            pair_relation_time_choice,
        ...
        TripletReassemblyAlgorithmConsistency {
            ...
            qoaimnipn,
            qoaimnita,
            //queued_by_offset_slow_chunk_alteration_no_merging_ignore_pair_all_drop,
            //queued_by_offset_slow_chunk_alteration_no_merging_ignore_pair_newest_drop,
            qoadmnita,
            qoaimmipa,
            qoaimmipn,
            qoaimmita,
            //queued_by_offset_slow_chunk_alteration_meet_merging_ignore_pair_all_drop,
            //queued_by_offset_slow_chunk_alteration_meet_merging_ignore_pair_newest_drop,
            qoadmmita,
            qoaimaipa,
            qoaimaipn,
            qoaimaita,
            //queued_by_offset_slow_chunk_alteration_any_merging_ignore_pair_all_drop,
            //queued_by_offset_slow_chunk_alteration_any_merging_ignore_pair_newest_drop,
            qoadmaita,
        }
    }
    ...
    pub fn build_queued_by_offset_fast_chunk_alteration_no_merging(
        ...
        //triplet_position_policy: &TripletPositionPolicy, 
        relation_triplet_d: &RelationTripletD, 
        //ignore_as_triplet_all_drop: bool
        pair_ignore_interpretation: PairIgnoreInterpretation
    ) -> PolicyConsistency {
        debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: start");
        debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: pair_ignore_interpretation: {:?}",pair_ignore_interpretation);
        ...
        if Self::is_data_hole_from_relation_triplet(&relation_01, &relation_02, &relation_12) {
            // early return
            return Self::check_payload_consistency(
                &vec![],
                payload_string_option,
            )
        }
        ...
        //if ignore_as_triplet_all_drop && *r_01_pair_relation_time_choice == PairChoice::Ignore {
        //    // early return                                         
        ...
        //    )
        //}
        let step_01_interval_v = if *r_01_pair_relation_time_choice == PairChoice::Ignore && pair_ignore_interpretation == PairIgnoreInterpretation::FlowAllChunksDrop {
            // early return                                         
            debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: end");
            return Self::check_payload_consistency(
                &vec![],
        ...
        let should_early_return = 'should_early_return: { 
            for (interval_d_o,chunk_id) in step_01_interval_v.iter() {
                match interval_d_o {
                    Some(interval_d) => {
                        match &curr_interval_2_o {
                            Some(curr_interval_2) => {
                                ...
                                //if ignore_as_triplet_all_drop && *curr_pair_choice == PairChoice::Ignore {
                                //    // early return                                         
                                //    break 'should_early_return true;
                                //}

                                if *curr_pair_choice == PairChoice::Ignore && pair_ignore_interpretation == PairIgnoreInterpretation::FlowAllChunksDrop {
                                    // early return                                         
                                    break 'should_early_return true;
                                }
                                ...
                                for (after_resolution_interval_d_o,after_resolution_chunk_id) in after_resolution_interval_v.iter() {
        ...
        if let Some(curr_interval_2) = curr_interval_2_o  {
            if curr_interval_2.get_start() * factor == curr_reassembly_roff {
                reassembled_chunk_interval_no_overlap_v.push((
                    2,
                    curr_interval_2.clone()
                ));
                debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: reassembled_chunk_interval_no_overlap_v: {:?}",reassembled_chunk_interval_no_overlap_v);
                curr_reassembly_roff = (curr_interval_2.get_end() + 1) * factor;
                debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: curr_reassembly_roff: {:?}",curr_reassembly_roff);
            }
        }

        let theorical_end = (interval_c.get_rightmost_ending_data_offset() + 1)* factor;
        
        // build the reassembled payload
        let reconstructed_payload_ascii_v: Vec<u8> = if theorical_end == curr_reassembly_roff {
            Self::build_reconstructed_payload_ascii_v(
                chunk_c,
                payload_mode,
    ...
    pub fn build_queued_by_offset_slow_chunk_alteration_no_merging(
        ...
        debug!("build_queued_by_offset_slow_chunk_alteration_no_merging: pair_ignore_interpretation: {:?}",pair_ignore_interpretation);

        assert_eq!(pair_ignore_interpretation,PairIgnoreInterpretation::FlowAllChunksDrop);
        ...
        let should_early_return = 'should_early_return: { 
            for (interval_d_o,chunk_id) in step_01_interval_v.iter() {
                if let Some(interval_d) = interval_d_o {
                    ...
                    if pair_ignore_interpretation == PairIgnoreInterpretation::FlowAllChunksDrop && *curr_pair_choice == PairChoice::Ignore {
                        // early return                                         
                        break 'should_early_return true;
                    }
        ...
        if interval_2_start * factor == curr_reassembly_roff {
            ...
            reassembled_chunk_interval_no_overlap_v.push((
                2,
                remaining_interval_2.clone()
            ));
            debug!("build_queued_by_offset_slow_chunk_alteration_no_merging: reassembled_chunk_interval_no_overlap_v: {:?}",reassembled_chunk_interval_no_overlap_v);
            curr_reassembly_roff = (remaining_interval_2.get_end() + 1) * factor;
            debug!("build_queued_by_offset_fast_chunk_alteration_no_merging: curr_reassembly_roff: {:?}",curr_reassembly_roff);
        }
    ...
    //) -> (Option<Vec<IntervalD>>,Option<Vec<IntervalD>>) {
        ...
        let (revised_interval_a_v_o,revised_interval_b_v_o) = match pair_choice {
            ...
            PairChoice::Ignore => {
                ...
                match pair_ignore_interpretation {
                    PairIgnoreInterpretation::FlowAllChunksDrop | PairIgnoreInterpretation::PairAllChunksDrop  => {
                        (None,None)
                    }
                    PairIgnoreInterpretation::PairNewestChunkDrop => {
                        if pair_time_position == PairTimePosition::Before {
                            (Some(vec![original_interval_a.clone()]),None)
                        } else {
                            (None,Some(vec![original_interval_b.clone()]))
                        }
                    }
                }
        ...
        //debug!("build_queued_by_offset_slow_chunk_alteration_no_merging: interval_v: {:?}",interval_v);
        //debug!("build_queued_by_offset_slow_chunk_alteration_no_merging: interval_v: {:?}",interval_v);
        interval_v
    }
    ...
    pub fn build_queued_by_offset_meet_merging(
        ...
        // TODO Check if hole before reassembling ?


        debug!("build_queued_by_offset_meet_merging: start");
        debug!("build_queued_by_offset_meet_merging: is_fast: {}",is_fast);
        debug!("build_queued_by_offset_meet_merging: pair_ignore_interpretation: {:?}",pair_ignore_interpretation);
        //let relation_triplet_d = triplet_position_policy.get_relation_triplet();
        ...
        let interval_chunkid_t_v: Vec<(Option<IntervalD>,u16)> = match relation_01_2 {
            ...
            _ => {
                ...
                if pair_ignore_interpretation == PairIgnoreInterpretation::FlowAllChunksDrop && *r_01_2_pair_relation_time_choice == PairChoice::Ignore {
                    // early return                                         
                    debug!("build_queued_by_offset_meet_merging: end");
                    return Self::check_payload_consistency(
                        &vec![],
                        payload_string_option,
                    )
        ...
        let tc_end = chunk_c.get_ending_chunk_offset();
        debug!("build_queued_by_offset_meet_merging: tc_end: {:?}",tc_end);

        let reconstructed_payload_ascii_v = if !Self::is_data_hole_from_reassembled_chunk_interval_no_overlap_v(&reassembled_chunk_interval_no_overlap_v,tc_end) {
            Self::build_reconstructed_payload_ascii_v(
                &new_chunk_c,
                payload_mode,
                reassembled_chunk_interval_no_overlap_v
    ...
    pub fn build_queued_by_offset_any_merging(
        ...
        debug!("build_queued_by_offset_any_merging: is_fast: {}",is_fast);
        debug!("build_queued_by_offset_any_merging: pair_ignore_interpretation: {:?}",pair_ignore_interpretation);
        //let relation_triplet_d = triplet_position_policy.get_relation_triplet();
        ...
        let (new_chunk_c,interval_chunkid_t_v): (ChunkC,Vec<(Option<IntervalD>,u16)>) = if *r_01_pair_relation_time_choice == PairChoice::Ignore && pair_ignore_interpretation != PairIgnoreInterpretation::PairNewestChunkDrop { 
            //if pair_ignore_interpretation == PairIgnoreInterpretation::FlowAllChunksDrop {
            //    // early return                                         
            //    debug!("build_queued_by_offset_any_merging: end");
            //    return Self::check_payload_consistency(
            //        &vec![],
            //        payload_string_option,
            //    )
            ...
            // else  pair_ignore_interpretation == PairIgnoreInterpretation::PairAllChunksDrop
            let bm = BTreeMap::from([(2,chunk_2.clone())]);
            let new_chunk_c = ChunkC::new(bm);
            let interval_chunkid_t_v = if chunk_2.get_start() {
                    vec![(Some(interval_2),2)]
            ...
            debug!("build_queued_by_offset_any_merging: chunk_01_interval_v: {:?}",chunk_01_interval_v);

            let chunk_01 = Self::merge_chunk_01_after_overlap_resolution(
                chunk_01_interval_v.clone(),
                chunk_c,
                payload_mode,
            );
            ...
            //let start_01 = min(interval_0.get_start(),interval_1.get_start());  
            //let end_01 = max(interval_0.get_end(),interval_1.get_end());
            // we don't if both 0 and 1 are in chunk_01_interval_v so ...
            let start_v: Vec<_> = chunk_01_interval_v.iter().filter_map(|(interval_d_o,_)| if let Some(interval_d) = interval_d_o { Some(interval_d.get_start()) } else { None }).collect();
            let end_v: Vec<_> = chunk_01_interval_v.iter().filter_map(|(interval_d_o,_)| if let Some(interval_d) = interval_d_o { Some(interval_d.get_end()) } else { None }).collect();
            let start_01 = start_v.into_iter().min().unwrap();
            let end_01 = end_v.into_iter().max().unwrap();
            let interval_01 = IntervalD::new(start_01,end_01);
    ...
    pub fn build_reconstructed_payload_ascii_v(
        ...
        reassembled_chunk_interval_no_overlap_v
            ...
            .map(|(chunk_id,interval_d)| {
                ...
                debug!("build_reconstructed_payload_ascii_v: interval_d.get_start(): {}",interval_d.get_start());
                debug!("build_reconstructed_payload_ascii_v: interval_d.get_end(): {}",interval_d.get_end());
                debug!("build_reconstructed_payload_ascii_v: chunk_offset: {}",chunk_offset);
    ...
    pub fn merge_chunk_01_after_overlap_resolution(
        ...
        assert!(chunk_01_interval_v.iter().find(|(interval_d_o,_)| interval_d_o.is_some()).is_some());

        let chunk_0 = chunk_c.get(&0).unwrap();
        let chunk_1 = chunk_c.get(&1).unwrap();
        //let does_01_start = chunk_0.get_start() | chunk_1.get_start();
        //let offset_01 = min(chunk_0.get_offset(),chunk_1.get_offset());
        let mut does_01_start = false; // we don't if both 0 and 1 are in chunk_01_interval_v 
        let mut offset_01 = max(chunk_0.get_offset(),chunk_1.get_offset());
        ...
        chunk_01_interval_v
            ...
            .for_each(|(interval_d_o,chunk_id)| {
                ...
                does_01_start |= chunk.get_start();
                if chunk.get_offset() < offset_01 { offset_01 = chunk.get_offset() };
    ...
    pub fn is_data_hole_from_relation_triplet(
        ...
        return before_relation_like_number >= 2
    }

    pub fn is_data_hole_from_reassembled_chunk_interval_no_overlap_v(
        ordered_interval_d_v: &Vec<(u16,IntervalD)>,
        tc_end: u16
    ) -> bool {
        let mut curr_reassembly_roff = 0;
        for (_,interval_d) in ordered_interval_d_v {
            if interval_d.get_start() != curr_reassembly_roff {
                return true
            }
            curr_reassembly_roff = interval_d.get_end() + 1;
        }
        curr_reassembly_roff != tc_end
    }
