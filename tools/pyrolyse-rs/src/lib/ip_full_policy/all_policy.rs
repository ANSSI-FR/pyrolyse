...
use crate::ip_full_policy::triplet_policy_data::TripletPolicyDataC;
use crate::ip_full_policy::pair_position_policy_data::PairPositionPolicyDataC;
...
impl AllPolicy {
    ...
    pub fn of_data(
        ...
        print!("pair_position_policy_data_c: {:?}",pair_position_policy_data_c);
        let pair_relation_time_choice =
            PairRelationTimeChoice::of_ip_full_pair_position_policy_data_c(
                &pair_position_policy_data_c,
            );
        print!("pair_relation_time_choice: {:?}",pair_relation_time_choice);
