...
use crate::ip_full_policy::triplet_policy::TripletPolicy;
...
use crate::ip_full_policy::triplet_reassembly_algorithm_consistency::TripletReassemblyAlgorithmConsistency;
use crate::ip_full_policy::triplet_individual_consistency_with_isolated_pairs::TripletIndividualConsistencyWithIsolatedPairs;
// use crate::ip_full_policy::triplet_pair_position_policy::TripletPairPositionPolicy;
...
impl TripletPolicyDataD {
    ...
    fn of_data(
        ...
        let consistent_pair_position_policy_01_bat =
            time_policy_triplet_residual_01.extract_policy_consitency(pair_relation_time_choice_01);
        let consistent_pair_position_policy_02_bat =
            time_policy_triplet_residual_02.extract_policy_consitency(pair_relation_time_choice_02);
        let consistent_pair_position_policy_12_bat =
            time_policy_triplet_residual_12.extract_policy_consitency(pair_relation_time_choice_12);
