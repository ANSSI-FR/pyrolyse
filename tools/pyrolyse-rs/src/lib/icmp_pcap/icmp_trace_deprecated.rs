...
use crate::icmp_pcap::icmp_packet_deprecated::IcmpPacket;
...
pub struct IcmpTraceC {
    hm: HashMap<TestIndex, IcmpTraceD>,
}

impl FromIterator<(TestIndex, IcmpTraceD)> for IcmpTraceC {
    fn from_iter<U>(iter: U) -> Self
    where
        U: IntoIterator<Item = (TestIndex, IcmpTraceD)>,
    {
        Self {
...
impl IcmpTraceC {
    ...
    pub fn get(&self, index: &TestIndex) -> Option<&IcmpTraceD> {
        self.hm.get(index)
    }

    pub fn iter(&self) -> Iter<TestIndex, IcmpTraceD> {
        self.hm.iter()
    }
    ...
    pub fn build_icmp_header_data_v(
        ...
        let icmp_packet_data = icmp_echo_request_generation_deprecated::build_icmp_data(
            test_index.0,
            sequence_index,
            &data,
            &ip_src,
    ...
    pub fn of_data_byte_time_pair_sequence_c(
        ...
        let map = tuple_v
            ...
            .map(|(test_index, byte_time_pair_sequence_d)| {
                ...
                let icmp_header = IcmpTraceC::build_icmp_header_data_v(
                    policy_evaluation,
                    internet_checksum_chunk_pattern_sl,
                    **test_index,
                    byte_time_pair_sequence_d.get_byte_sequence_index().0,
        ...
        let map = tuple_v
            ...
            .map(|(test_index, byte_time_triplet_sequence_d)| {
                ...
                let icmp_header = IcmpTraceC::build_icmp_header_data_v(
                    ...
                    chunk_pattern_sl,
                    **test_index,
                    byte_time_triplet_sequence_d.get_byte_sequence_index().0,
