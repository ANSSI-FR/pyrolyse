...
pub struct PairPolicyDataD {
    ...
    relation_pair: AllenIntervalAlgebraRelation,
...
impl PairPolicyDataD {
    ...
    pub fn get_relation_pair(&self) -> &AllenIntervalAlgebraRelation {
        &self.relation_pair
    }

    pub fn get_time_policy_pair(&self) -> &PairTimePolicy {
    ...
    fn of_data(
        ...
        let time_policy_pair = position_policy.get_time_policy();
