...
impl PairPositionPolicy {
    ...
    pub fn of_data(
        ...
        let (pair_choice, pair_time_policy, pair_byte_policy) = match pair_position {
            ...
            PairPosition::Overlap(pair_overlap) => {
                ...
                // ((*byte_relation).clone(), pair_time_policy, pair_byte_policy)
                (pair_choice, pair_time_policy, pair_byte_policy)
            }
        };
